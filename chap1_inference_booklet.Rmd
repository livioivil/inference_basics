...
- **Type I error** (**False Positive**, $\alpha$): the probability to find a relationship when it does not exist (true $H_0$, the test judges $H_1$).
...
1. How does the type I error varies as a function of the sample size? (Same hint of homework 1, but here you sample `Age` `n` times and compute `yhat` )
...
<!-- plot(s_values,type1,type="l") -->

<!-- power=sapply(s_values,sim05,n,yhat) -->
<!-- plot(s_values,power,type="l") -->
<!-- ``` -->
