...
\begin{center}\includegraphics{chap1_inference_booklet_files/figure-latex/unnamed-chunk-3-1} \end{center}
...
\begin{center}\includegraphics{chap1_inference_booklet_files/figure-latex/unnamed-chunk-6-1} \end{center}
...
\begin{center}\includegraphics{chap1_inference_booklet_files/figure-latex/unnamed-chunk-7-1} \end{center}
...
\begin{center}\includegraphics{chap1_inference_booklet_files/figure-latex/unnamed-chunk-8-1} \end{center}
...
\(n=20\)? We got \(20!=\) 2.432902\times 10\^{}\{18\}. This is too big,
definitely!
...
\begin{center}\includegraphics{chap1_inference_booklet_files/figure-latex/unnamed-chunk-9-1} \end{center}
...
\begin{center}\includegraphics{chap1_inference_booklet_files/figure-latex/unnamed-chunk-11-1} \end{center}
...
\begin{center}\includegraphics{chap1_inference_booklet_files/figure-latex/unnamed-chunk-13-1} \end{center}
...
\begin{center}\includegraphics{chap1_inference_booklet_files/figure-latex/unnamed-chunk-15-1} \end{center}
...
\begin{center}\includegraphics{chap1_inference_booklet_files/figure-latex/unnamed-chunk-16-1} \end{center}
...
\begin{center}\includegraphics{chap1_inference_booklet_files/figure-latex/unnamed-chunk-22-1} \end{center}
...
\begin{center}\includegraphics{chap1_inference_booklet_files/figure-latex/unnamed-chunk-24-1} \end{center}
...
\begin{center}\includegraphics{chap1_inference_booklet_files/figure-latex/unnamed-chunk-28-1} \end{center}
...
\begin{center}\includegraphics{chap1_inference_booklet_files/figure-latex/unnamed-chunk-30-1} \end{center}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{sim05 <-}\StringTok{ }\ControlFlowTok{function}\NormalTok{(s,n,m)\{}
\NormalTok{  p.sim=}\KeywordTok{replicate}\NormalTok{(}\DecValTok{1000}\NormalTok{,}\KeywordTok{sim}\NormalTok{(reaction}\OperatorTok{$}\NormalTok{Age,n,m,s))}
  \KeywordTok{mean}\NormalTok{(p.sim}\OperatorTok{<}\NormalTok{.}\DecValTok{05}\NormalTok{)}
\NormalTok{\}}
\end{Highlighting}
...
\begin{center}\includegraphics{chap1_inference_booklet_files/figure-latex/unnamed-chunk-32-1} \end{center}
...
\begin{center}\includegraphics{chap1_inference_booklet_files/figure-latex/unnamed-chunk-33-1} \end{center}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{sim_n <-}\StringTok{ }\ControlFlowTok{function}\NormalTok{(Age,n,betas,s)\{}
\NormalTok{  Agex <-}\StringTok{ }\KeywordTok{sample}\NormalTok{(Age,n,}\DataTypeTok{replace =} \OtherTok{TRUE}\NormalTok{)}
  \ControlFlowTok{while}\NormalTok{(}\KeywordTok{length}\NormalTok{(}\KeywordTok{unique}\NormalTok{(Agex))}\OperatorTok{==}\DecValTok{1}\NormalTok{)}
\NormalTok{    Agex <-}\StringTok{ }\KeywordTok{sample}\NormalTok{(Age,n,}\DataTypeTok{replace =} \OtherTok{TRUE}\NormalTok{)}
  
\NormalTok{  y_linear_part=betas[}\DecValTok{1}\NormalTok{]}\OperatorTok{+}\NormalTok{betas[}\DecValTok{2}\NormalTok{]}\OperatorTok{*}\NormalTok{Agex}
\NormalTok{  Reaction.Time <-}\StringTok{ }\KeywordTok{rnorm}\NormalTok{(n,y_linear_part,s)}
  \CommentTok{#get the p-values from the output}
  \KeywordTok{summary}\NormalTok{(}\KeywordTok{lm}\NormalTok{(Reaction.Time}\OperatorTok{~}\NormalTok{Agex))}\OperatorTok{$}\NormalTok{coefficients[}\StringTok{"Agex"}\NormalTok{,}\StringTok{"Pr(>|t|)"}\NormalTok{]}
\NormalTok{\}}

\NormalTok{sim05_n <-}\StringTok{ }\ControlFlowTok{function}\NormalTok{(n,betas,s)\{}
\NormalTok{  p.sim=}\KeywordTok{replicate}\NormalTok{(}\DecValTok{1000}\NormalTok{,}\KeywordTok{sim_n}\NormalTok{(reaction}\OperatorTok{$}\NormalTok{Age,n,betas,s))}
  \KeywordTok{mean}\NormalTok{(p.sim}\OperatorTok{<}\NormalTok{.}\DecValTok{05}\NormalTok{)}
\NormalTok{\}}
\end{Highlighting}
\end{Shaded}
...
\KeywordTok{plot}\NormalTok{(ns,type1,}\DataTypeTok{type=}\StringTok{"l"}\NormalTok{,}\DataTypeTok{ylim=}\KeywordTok{c}\NormalTok{(}\DecValTok{0}\NormalTok{,.}\DecValTok{2}\NormalTok{),}\DataTypeTok{main=}\StringTok{"Type I error"}\NormalTok{,}\DataTypeTok{xlab=}\StringTok{"sample size"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\begin{center}\includegraphics{chap1_inference_booklet_files/figure-latex/unnamed-chunk-35-1} \end{center}
...
\begin{center}\includegraphics{chap1_inference_booklet_files/figure-latex/unnamed-chunk-36-1} \end{center}
...
\NormalTok{  Reaction.Time=}\KeywordTok{rnorm}\NormalTok{(n,m,s)}
  \CommentTok{#get the p-value from the output}
\NormalTok{  CI=}\KeywordTok{confint}\NormalTok{(}\KeywordTok{lm}\NormalTok{(Reaction.Time}\OperatorTok{~}\NormalTok{Age))[}\DecValTok{2}\NormalTok{,]}
\NormalTok{  contained=}\KeywordTok{all}\NormalTok{(}\KeywordTok{sign}\NormalTok{(CI)}\OperatorTok{==}\KeywordTok{c}\NormalTok{(}\OperatorTok{-}\DecValTok{1}\NormalTok{,}\DecValTok{1}\NormalTok{))}
\NormalTok{  CI_length=CI[}\DecValTok{2}\NormalTok{]}\OperatorTok{-}\NormalTok{CI[}\DecValTok{1}\NormalTok{]}
  \KeywordTok{names}\NormalTok{(CI_length)=}\OtherTok{NULL}
  \KeywordTok{c}\NormalTok{(contained,CI_length)}
\NormalTok{\}}

\NormalTok{sim05 <-}\StringTok{ }\ControlFlowTok{function}\NormalTok{(s,n,m)\{}
\NormalTok{  p.sim=}\KeywordTok{replicate}\NormalTok{(}\DecValTok{1000}\NormalTok{,}\KeywordTok{sim}\NormalTok{(reaction}\OperatorTok{$}\NormalTok{Age,n,m,s))}
  \KeywordTok{rowMeans}\NormalTok{(p.sim)}
\NormalTok{\}}
\end{Highlighting}
\end{Shaded}
...
\begin{center}\includegraphics{chap1_inference_booklet_files/figure-latex/unnamed-chunk-38-1} \end{center}
...
\begin{center}\includegraphics{chap1_inference_booklet_files/figure-latex/unnamed-chunk-39-1} \end{center}
...
\NormalTok{  y_linear_part=betas[}\DecValTok{1}\NormalTok{]}\OperatorTok{+}\NormalTok{betas[}\DecValTok{2}\NormalTok{]}\OperatorTok{*}\NormalTok{Agex}
\NormalTok{  Reaction.Time <-}\StringTok{ }\KeywordTok{rnorm}\NormalTok{(n,y_linear_part,s)}
\NormalTok{  CI=}\KeywordTok{confint}\NormalTok{(}\KeywordTok{lm}\NormalTok{(Reaction.Time}\OperatorTok{~}\NormalTok{Agex))[}\DecValTok{2}\NormalTok{,]}
\NormalTok{  contained=}\KeywordTok{all}\NormalTok{(}\KeywordTok{sign}\NormalTok{(CI)}\OperatorTok{==}\KeywordTok{c}\NormalTok{(}\OperatorTok{-}\DecValTok{1}\NormalTok{,}\DecValTok{1}\NormalTok{))}
\NormalTok{  CI_length=CI[}\DecValTok{2}\NormalTok{]}\OperatorTok{-}\NormalTok{CI[}\DecValTok{1}\NormalTok{]}
  \KeywordTok{names}\NormalTok{(CI_length)=}\OtherTok{NULL}
  \KeywordTok{c}\NormalTok{(contained,CI_length)}
...
\begin{center}\includegraphics{chap1_inference_booklet_files/figure-latex/unnamed-chunk-41-1} \end{center}
...
\begin{center}\includegraphics{chap1_inference_booklet_files/figure-latex/unnamed-chunk-42-1} \end{center}
